#!/usr/bin/env python3
"""Erzeugt die Marken-Bilder der Integration aus brands/icon.svg.
...
# Genau dieser Ordner wird ausgeliefert: Home Assistant erkennt eine
# Integration als "hat Marke", wenn neben ihren Modulen ein Ordner "brand"
# liegt, und reicht dessen Bilder über /api/brands/integration/... heraus.
ZIEL = WURZEL / "custom_components" / "pv_system" / "brand"
