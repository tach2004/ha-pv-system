...
# Die beiden Verbräuche als fortlaufender Zähler in kWh - siehe stunde.py.
KEY_HOUSE_ENERGY_TOTAL: Final = "house_energy_total"
KEY_BASE_ENERGY_TOTAL: Final = "base_energy_total"
